...
|---|---|---|---|
| [Bühler Heston](../benchmarks/configs/buehler-heston.json) | Heston QE-M, spot 100, 30 decisions, 365-day clock | Stock and variance swap, with cash | ES50; MSE is an available variation |
| [AlphaZero Heston](../benchmarks/configs/szehr-heston-stock.json) | Heston QE-M, spot 1, 60 decisions, 365-day clock | Stock and cash | MSE |
| [AlphaZero GBM](../benchmarks/configs/szehr-gbm-stock.json) | GBM, spot 1, volatility 30%, 30 decisions, 365-day clock | Stock and cash | MSE |
...
path = Path("benchmarks/configs/buehler-heston.json")
...
`hedging_gym.environment.paper_benchmarks`. For example:

...
| Buehler, Murray and Wood, [Deep Bellman Hedging](https://arxiv.org/abs/2207.00932v3) | Actor-critic value iteration for hedging under a monetary utility, with existence and uniqueness of the Bellman fixed point. [Our implementation](../src/hedging_gym/baselines/deep_bellman_hedging.py) samples simulated books instead of tabulated history and keeps the reward inside the utility as in the paper's definition. |

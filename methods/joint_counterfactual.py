"""All-mode expected score gradients plus HPO's live-history pathwise term.

This is a source-attributed mixed-gradient adaptation, not a new estimator
theorem or an exact conditional-Q optimizer. See docs/joint-counterfactual.md.
"""
...
from .checkpoints import (save_checkpoint, load_checkpoint, check_resume_options,

"""SRSA-style transfer-risk retrieval for a frozen AdaptiveDH context library.

Source: Guo et al. (2025), https://arxiv.org/abs/2503.04538, Eq. (1).
The paired-feature ReLU/MSE predictor follows NVlabs/SRSA's SuccPreNetwork.fc.
Our skills are source task vectors, and lower cost-inclusive ES replaces higher
robotic success. This is a retrieval adaptation, not the full robotic system.
"""
...
from .checkpoints import rng_state, save_checkpoint

"""SB3 vector-environment bridge to the authoritative financial ledger.

Shared by PPO, CrossQ and TQC. The upstream VecEnv interface is documented at
https://stable-baselines3.readthedocs.io/en/v2.9.0/guide/vec_envs.html.
Method-specific inference belongs to its public method module or the shared
SAC-family adapter; this module contains no learner or additional market model.
"""
...
from hedging_gym.environment.finance import bank_subset, observation_fields

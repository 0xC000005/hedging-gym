...
Modified PyTorch learner port; source and changes: docs/baseline-methods.md.
Upstream Apache learner: https://github.com/rotmanfinhub/gamma-vega-rl-hedging/blob/77dc48326da000d983b1fb750edb2177e38c75fd/agent/learning.py
Retained license text: docs/belief-fb-LICENSE.txt.

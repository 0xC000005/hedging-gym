...
Paper: Zero-Shot Adaptation of Behavioral Foundation Models to Unseen Dynamics,
ICLR 2026, https://proceedings.iclr.cc/paper_files/paper/2026/hash/cd7fe6d521c3fc74c5363a7e29f47910-Abstract-Conference.html
Upstream: https://github.com/maxsbob/BeliefConditionedFB/tree/30e7487ca033c3619ec744ed55f916ece005c425
Implementation notes: docs/belief-adaptation.md.
License: Apache-2.0, retained in docs/belief-fb-LICENSE.txt.

This modified PyTorch port transfers DynamicsTransformer, Encoder1DBlock,
NextStatePrediction and context_encoder_loss, not full Belief-FB or Rotation-FB.
The encoder uses prior training histories; declared Heston parameters remain
observable. TaskEmbeddedPolicy and the shared ledger handle financial training.
"""
...
def encode_bank_context(encoder, prior_training_bank, *, history_paths=32, context_length=20):
    ...
    from hedging_gym.environment.finance import bank_subset
...
class BeliefEmbeddedPolicy(TaskEmbeddedPolicy):
    ...
    method_name = "belief_encoder_dh"
    method_label = "Belief-FB context-encoder transfer with Deep Hedging"

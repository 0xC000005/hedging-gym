"""CrossQ using the unchanged SB3-Contrib 2.9.0 learner.

Paper: Bhatt et al., CrossQ (ICLR 2024).
https://arxiv.org/abs/1902.05605v4
Implementation:
https://github.com/Stable-Baselines-Team/stable-baselines3-contrib/tree/v2.9.0/sb3_contrib/crossq
...
__all__ = ["build_crossq", "load", "save", "make_controller"]


def build_crossq(env, *, seed=7, device="cpu", buffer_size=1_000_000,
    ...
    return CrossQ("MlpPolicy", env, seed=seed, device=device,
...
def load(directory, env, *, device="cpu"):
    ...
    return load_off_policy(CrossQ, directory, env, device=device)

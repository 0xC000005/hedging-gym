...
from experiments.compare_adapt_aware import (
    BUDGETS, FAMILIES, MODES, PATH_COUNTS, RATES, SEEDS, TEST_MARKETS,
)
            ...
            for target in TEST_MARKETS:
                for mode in MODES:
                    ...
                    for count in PATH_COUNTS:
                        ...
                        require(config_from_dict(curve["config"]) == bank.config,

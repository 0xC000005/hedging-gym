...
Run from a checkout: uv run --frozen python -m benchmarks.baselines.
...
from hedging_gym.baselines.hpo import train_hybrid
...
from hedging_gym.environment.config import RiskConfig, TimeGrid, config_from_dict
...
def main(argv=None):
    ...
    controllers = {
        ...
        "delta_band": delta_controller(band=args.delta_band),
        "delta_gamma": delta_gamma_controller(),
        "delta_variance": delta_variance_controller(),
    }
    planners = {}

"""Compare three context-adaptation mechanisms on the current Heston task.
...
from hedging_gym.baselines.belief_adaptation import (
    BeliefDynamicsEncoder,
    BeliefEmbeddedPolicy,
    encode_bank_context,
    train_belief_encoder,
)
from hedging_gym.baselines.geps import GEPSPolicy
from hedging_gym.environment.benchmark import benchmark_config
from hedging_gym.environment.finance import BANK_FIELDS, generate_market_bank

...
from benchmarks.qualify_sb3 import load_bank
...
def main():
    ...
    if args.resume:
        model, state = {'crossq': load_crossq, 'tqc': load_tqc}[args.algorithm](args.resume, env, device=args.device)
        ...
        model = {'crossq': build_crossq, 'tqc': build_tqc}[args.algorithm](env, seed=args.seed, device=args.device,
    ...
    reloaded, _ = {'crossq': load_crossq, 'tqc': load_tqc}[args.algorithm](args.output_dir / f"phase{args.phases}", env, device=args.device)

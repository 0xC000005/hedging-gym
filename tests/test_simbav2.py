...
from hedging_gym.baselines.simbav2 import RawLossReplay
...
def test_simba_rejects_unsupported_contract_before_loading_donor():
    from hedging_gym.baselines.simbav2 import SimBaV2Hedger
...
def test_official_update_full_checkpoint_continuation_and_ledger(tmp_path):
    ...
    from benchmarks.qualify_simbav2 import collect, evaluate
    from hedging_gym.baselines.simbav2 import NETWORKS, SimBaV2Hedger

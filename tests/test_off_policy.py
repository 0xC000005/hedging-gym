...
from methods.off_policy import (TerminalRiskReplayBuffer, build_off_policy,
    load_off_policy, off_policy_controller, save_off_policy, set_risk_threshold)
...
def test_stock_training_resume_and_independent_ledger(algorithm, tmp_path):
    ...
    model = build_off_policy(algorithm, env, seed=7, buffer_size=64,
    ...
    loaded, runner = load_off_policy(tmp_path / "checkpoint", loaded_env)
